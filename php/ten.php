        ...
        <div class="input_card">
            ...
            <div class="description">
                <div class="details">
                    ...
                    $len = count($a);
                    $pattern_len = strlen($a[$len-1]);
                    

                    echo"Entered lines are = <br>";
                    foreach($a as $i => $n){
                        if($i==$len-1)
                            echo"<br>And pattern is =";
                        if(strlen($n)!=0)
                            echo " \"".$n."\"<br>";}
                    echo "<br><br>";

                    $a[$len-1]=strtolower($a[$len-1]);
                    $containsAny = 0;
                    ...
                    foreach($a as $i => $n){
                        ...
                        if(is_string($n)){
                            ...
                            $currSubStrCount=1;
                            $copy=strtolower($n);
                            while($index<=strlen($copy)-$pattern_len){
                                if(strcmp(substr($copy,$index,$pattern_len),$a[$len-1])==0){
                                    if($hasSubsStrPresent==0){
                                        echo "<br>".$n." = <br>";
                                        ++$hasSubsStrPresent;
                                        
                                    }
                                    echo $currSubStrCount.".  ".substr($n,0,$index)."(".substr($n,$index,$pattern_len).")".substr($n,$index+$pattern_len,strlen($n)-$index-$pattern_len)."<br>";
                                    ++$containsAny;
                                    ++$currSubStrCount;
                                }
                                ++$index;
                    ...
                    if($containsAny==0)
                        echo "No line contains a single substring which equals \"".$a[$len-1]."\"";
                    else
                        echo "----------------------------------<br>Total substrings found matching \"".$a[$len-1]."\" <br> = ".$containsAny;
