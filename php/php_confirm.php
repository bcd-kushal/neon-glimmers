    ...
    <body>
        ...
        <div class="input_card">
            ...
            <div class="description">
                <div class="details">
                    <span>
                        <container style="color: rgb(255, 51, 51);">Confirm enter</container>
                    </span>
                    
                </div>
                <div class="forms">
                    
                        <div class="another" style="color:gray">Username : </div><div class="highlight" style="font-weight:bolder;font-style:italic;"><?php echo $username; ?></div>
                        <div class="another" style="color:gray">Password : </div><div class="highlight" style="font-weight:bolder;font-style:italic;"><?php 
                            ...
                            for($i=0;$i<strlen($password)-2;$i++)
                                echo "*";
                            echo substr($password,strlen($password)-2);}
                        ?></div>
                        </div>
                            <div class="resetVal">
                                <a href="php_encrypt.php" style="background:#0400ff;opacity:.9;">YES PROCEED -></a>
                            </div>
                        <div class="submitVal">
                                <a href="encrypt.html" style="background:rgba(255,255,255,.1);"><- NO GO BACK</a>
                            </div>
