            ...
            <div class="description">
                <div class="details">
                    ...
                    function countWords($str){
                        ...
                        for($i=0;$i<$len;$i++){
                            if(strcmp(" ",$str[$i])==0){
                                $sub=substr($str,$index,$i-$index);
                                $flag=0;
                                for($j=0;$j<count($words);$j+=2){
                                    if(strcmp($words[$j],$sub)==0){
                                        ++$words[$j+1];
                                        $flag=1;
                                    }
                                }
                                if($flag==0)
                                    array_push($words,$sub,1);
                                $index=$i+1;
                            }
                        }
                        for($j=2;$j<count($words);$j+=2){
                            echo "\"".$words[$j]."\" = ".$words[$j+1]."<br>";
                        }
                    }
