        ...
        <div class="input_card">
            ...
            <div class="description">
                <div class="details">
                    ...
                    echo "[ Original sentence = ]<br>".$a;
                    $len = strlen($a);
                    $count=array(0,array(),0,array(),0,array(),0,array(),0);//vowel, consonants, spaces, digit, spl_char
                    ...
                    while($index<$len){
                        if(strcmp(" ",substr($a,$index,1))==0)
                            ++$count[0];
                        elseif(($a[$index]>="a" && $a[$index]<="z")||($a[$index]>="A" && $a[$index]<="Z")){
                            $flag=0;
                            foreach($v as $i => $n)
                                if($n==$a[$index]){
                                    $count[1][$a1]=$a[$index];
                     ...
                     echo "<br><br>Vowels";
                     echo displayArr($count[1])."= ".$count[2];
                     echo "<br><br>Consonants";
                     echo displayArr($count[3])."= ".$count[4];
                     echo "<br><br>Digits";
                     echo displayArr($count[5])."= ".$count[6];
                     echo "<br><br>White spaces";
                     echo " = ".$count[2];
                     echo "<br><br>Other characters";
                     echo displayArr($count[7])."= ".$count[8];
                     echo "<br><br>Total characters = ".$count[9];
            }
                else
                    echo "<br><br>No Data input.";
                    ?>
                    </span> 
                </div>
            </div>
