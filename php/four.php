        ...
        <div class="input_card">
            ...
            <div class="description">
                <div class="details">
                    ...
                    if($cols_a!=count($b))
                        echo "Columns of first matrix (=".$cols_a.") does not match Rows of second matrix (=".count($b).")<br>>>Matrix multiplication not possible.";
                    else{
                        echo "= {";
                    for($i=0; $i<$row_a; $i++){
                        echo "{ ";
                    ...
                    echo "<br><br>Resultant Matrix =<br>";
                    showMatrix($c);
                    echo "<br><br>";
                      }
                    ?>
