            ...
            <div class="description">
                <div class="details">
                    ...
                    for($i=0;$i<$len;$i++){
                        ...
                        for($j=2;$j<$a[$i]/2;$j++){
                            if($a[$i]%$j==0 && isPrime($j,2)==1){
                                if($cnt==0)
                                    echo "[Prime Factors] &nbsp&nbsp&nbsp [Power]<br>";
                                $power=1;
                                $k=$j;
                                echo "(".$a[$i];
                                $c=$a[$i]/$j;
                                ...
                                echo ")&nbsp&nbsp";
                                echo $j."&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp".$power."<br>";
                                ++$cnt;
                            }
                        }
                        if($cnt==0)
                            echo $a[$i]." is a Prime in itself.<br>";
                        $cnt=0;
                    }}
                    ?>
                    </span> 
